  ...
  <div class="container-fluid">
    <div class="row">
      <aside class="col-md-2 d-none d-md-block bg-light sidebar" style = "height: 100vh;">
        ...
        <span style = "color : #FFFFFF;">Main Dashboard</span>
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link active animated-link" href="index.php">
            ...
            <li class="nav-item">
              <a class="nav-link animated-link" href="pengaman.php">
      ...
      <main class="col-md-10 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-18 pr-0 mb-6">
          ...
          <div class="col-lg-6 col-md-6 col-sm-18 pr-0 mb-6">
            ...
            url('img/panelsurya.jpg'); background-position : center; border-radius: 15px; box-shadow: 0px 0px 20px 3px rgba(55, 140, 231);">
              <div class="card-header" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);"><i class="fa fa-sun-o"></i> Tegangan Turbin</div>
                <div class="card-body">
                  <h3 class="card-title" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                  <?php
                  echo $tegangandc2
          ...
          <div class="card text-white" style="background: linear-gradient(to top, rgba(83, 86, 255, 0.5), rgba(55, 140, 231, 1.5)), 
          url('img/panelsurya2.jpg'); background-position : center; border-radius: 15px; box-shadow: 0px 0px 20px 3px rgba(55, 140, 231);">
              <div class="card-header" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);"><i class="fa fa-sun-o"></i> Arus Turbin</div>
              <div class="card-body">
                <h3 class="card-title"style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                <?php
                  echo $arusdc2
          ...
          <div class="col-lg-6 col-md-6 col-sm-18 pr-0 mb-6">
            <div class="card text-white" style="background: linear-gradient(to top, rgba(83, 86, 255, 0.5), rgba(55, 140, 231, 1.5)), 
            url('img/panelsurya.jpg'); background-position : center; border-radius: 15px; box-shadow: 0px 0px 20px 3px rgba(55, 140, 231);">
              <div class="card-header" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);"><i class="fa fa-sun-o"></i> Tegangan Baterai</div>
                <div class="card-body">
                  <h3 class="card-title" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                  <?php
          ...
          <div class="card text-white" style="background: linear-gradient(to top, rgba(83, 86, 255, 0.5), rgba(55, 140, 231, 1.5)), 
          url('img/panelsurya2.jpg'); background-position : center; border-radius: 15px; box-shadow: 0px 0px 20px 3px rgba(55, 140, 231);">
              <div class="card-header" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);"><i class="fa fa-sun-o"></i> Arus Baterai</div>
              <div class="card-body">
                <h3 class="card-title"style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                <?php
