    ...
    <div class="row">
      <aside class="col-md-2 bg-light sidebar" style = "height: 100vh;">
        ...
        <span style = "color : #FFFFFF;">Main Navigation</span>
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link active animated-link" href="photovoltaic.php">
            ...
            <li class="nav-item">
              <a class="nav-link animated-link" href="beban.php">
      ...
      <main class="col-md-10 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          ...
          <a href="grafikpv.php" class="btn btn-sm btn-light" style="background: linear-gradient(to top, #E72929, #FF5BAE); color: white; padding: 0.25rem 1rem; font-size: 1.5rem;">
          Grafik 📊
          </a>
          </div>
        </div>
        <div class="row">
          ...
          <div class="card text-white" style="background: linear-gradient(to top, rgba(83, 86, 255, 0.5), rgba(55, 140, 231, 1.5)), 
          url('img/panelsurya3.jpg'); background-position : center; border-radius: 15px; box-shadow: 0px 0px 20px 3px rgba(55, 140, 231);">
              <div class="card-header" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);"><i class="fa fa-sun-o"></i> Tegangan PV</div>
              <div class="card-body">
                <h3 class="card-title"style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                  <?php
                  include 'bacavariabeltabel.php';
                    echo number_format($tegangandc, 2) . " V";
                  ?>
                </h3>
              </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 pr-0 mb-3">
          <div class="card text-white" style="background: linear-gradient(to top, rgba(83, 86, 255, 0.5), rgba(55, 140, 231, 1.5)), 
          url('img/panelsurya2.jpg'); background-position : center; border-radius: 15px; box-shadow: 0px 0px 20px 3px rgba(55, 140, 231);">
              <div class="card-header" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);"><i class="fa fa-sun-o"></i> Arus PV</div>
              <div class="card-body">
                <h3 class="card-title"style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                <?php
                  include 'bacavariabeltabel.php';
                    echo number_format($arusdc, 2) . " A";
                  ?>
                </h3>
              </div>
              <a class="card-footer text-left" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);" href="#">
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 pr-0 mb-3">
            <div class="card text-white" style="background: linear-gradient(to top, rgba(83, 86, 255, 0.5), rgba(55, 140, 231, 1.5)), 
            url('img/panelsurya.jpg'); background-position : center; border-radius: 15px; box-shadow: 0px 0px 20px 3px rgba(55, 140, 231);">
              <div class="card-header" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);"><i class="fa fa-sun-o"></i> Daya PV</div>
                <div class="card-body">
                  <h3 class="card-title" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                  <?php
                  include 'bacavariabeltabel.php';
                    echo number_format($dayadc, 2) . " W";
                  ?>
                  </h3>
                </div>
                <a class="card-footer text-left" style = "text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);" href="#">
...
<!-- keterangan tabel -->
            <div class="card-body">
              ...
              <style>
                ...
                .table thead {
                  background: linear-gradient(to left, #008DDA, #41C9E2);
                  border-radius: 10px;
            ...
            echo '<th scope="col">Tegangan AC (V)</th>';
            echo '<th scope="col">Arus DC (A)</th>';
            echo '<th scope="col">Daya (W)</th>';
            echo '</tr>';
            echo '</thead>';
            echo '<tbody>';
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo '<td>' . $row['tegangandc'] . '</td>';
              echo '<td>' . $row['arusdc'] . '</td>';
              
              // Menambahkan kolom hasil perkalian dengan batasan 2 angka di belakang koma
              $hasil_perkalian = $row['tegangandc'] * $row['arusdc'];
              $hasil_perkalian_formatted = number_format($hasil_perkalian, 2);
              echo '<td>' . $hasil_perkalian_formatted . '</td>';
