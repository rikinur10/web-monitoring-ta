    ...
    <div class="row">
      ...
      <main class="col-md-10 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          ...
          <a href="photovoltaic.php" class="btn btn-sm btn-light" style="background: linear-gradient(to top, #E72929, #FF5BAE); color: white; padding: 0.25rem 1rem; font-size: 1.5rem;">
          Back ☀
          </a>
          </div>
        </div>
            ...
            </i> Grafik <span style="color: #222831;">Photovoltaic</span></h1>
<!-----------------------------------------------------------------------------------------
        <?php
        // Koneksi ke database
