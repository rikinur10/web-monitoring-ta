    ...
    <div class="row">
      <aside class="col-md-2 d-none d-md-block bg-light sidebar" style = "height: 100vh;">
        ...
        <span style = "color : #FFFFFF;">Main Navigation</span>
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active animated-link" href="lingkungan.php">
      ...
      <main class="col-md-10 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          ...
          <a href="lingkungan.php" class="btn btn-sm btn-light" style="background: linear-gradient(to top, #E72929, #FF5BAE); color: white; padding: 0.25rem 1rem; font-size: 1.5rem;">
          Back 🌿
          </a>
          </div>
        </div>
            ...
            </i> Grafik <span style="color: #222831;">Lingkungan</span></h1>
<!-----------------------------------------------------------------------------------------
        <?php
        // Koneksi ke database
